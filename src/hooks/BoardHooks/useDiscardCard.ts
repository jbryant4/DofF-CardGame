...
//
// export default function useDiscardHandlers() {
...
//     ) => {
//       const boardToUse =
//         playerTurn === 'player1' ? playerOneBoard : playerTwoBoard;
//       const setBoardToUse =
//         playerTurn === 'player1' ? setPlayerOneBoard : setPlayerTwoBoard;
//
...
//       playerTurn === 'player1' ? [true, false] : [false, true];
